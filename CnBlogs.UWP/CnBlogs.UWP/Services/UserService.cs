...
namespace CNBlogs.UWP.HTTP
{
    ...
    static class UserService
    {
        ...
        public async static Task<CnUserInfo> GetCurrentUserInfo()
        {
            try
            {
                string html = await HttpService.SendPostRequest(_url_current_user_info, "");
                if (html != null)
                {
        ...
        public async static Task<object[]> DiggBlog(string blog_app, string post_id)
        {
            try
            {
                ...
                string json_result = await HttpService.SendPostRequest(url, body);
        ...
        public async static Task<string[]> GetWZTags()
        {
            try
            {
                ...
                string html_result = await HttpService.SendPostRequest(url, "{}");
                if (html_result != null)
                {
